...
## Pain
Советы других людей не учитывают личные ограничения и цели.
...
## Research notes
Fixture 015 intentionally varies persona, trigger, workaround and score profile while preserving the recurring JTBD signal.
...
## Switching forces
- **Push:** Советы других людей не учитывают личные ограничения и цели.
- **Pull:** Прозрачная criterion/evidence matrix, reversible recommendation и сохранённая rationale history.
- **Habit:** Пользователь уже опирается на текущий workaround: откладывание решения.
